...
public class CvController {
    ...
    public String dodajDoswiadczenie(Praca praca, @PathVariable Integer cvId){
        CV istnieje = repository.findById(cvId).get();
    ...
    public String usunDoswiadczenie(@PathVariable Integer cvId, @PathVariable Integer id) {
